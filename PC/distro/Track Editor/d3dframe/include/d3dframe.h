...
class CD3DFramework
{
    ...
    HRESULT CreateDDAndD3D( GUID*, GUID*, DWORD );
    HRESULT CreateEnvironment( HWND, GUID*, GUID*, DDSURFACEDESC2*, DWORD );
    VOID    Initialize();
...
public:
    ...
    HRESULT ChangeDriver( HWND hWnd, GUID* pDriverGUID, GUID* pDeviceGUID,
                          DDSURFACEDESC2* pddsd, DWORD dwFlags );
...
//-----------------------------------------------------------------------------
#define D3DFWERR_NODIRECTDRAW        0x80000001
#define D3DFWERR_COULDNTSETCOOPLEVEL 0x80000002
#define D3DFWERR_NODIRECT3D          0x80000003
#define D3DFWERR_NO3DDEVICE          0x80000004
#define D3DFWERR_NOZBUFFER           0x80000005
#define D3DFWERR_NOVIEWPORT          0x80000006
#define D3DFWERR_NOPRIMARY           0x80000007
#define D3DFWERR_NOCLIPPER           0x80000008
#define D3DFWERR_BADDISPLAYMODE      0x80000009
#define D3DFWERR_NOBACKBUFFER        0x8000000a
#define D3DFWERR_NONZEROREFCOUNT     0x8000000b
#define D3DFWERR_NORENDERTARGET      0x8000000c
