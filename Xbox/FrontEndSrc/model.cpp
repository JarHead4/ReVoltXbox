...
void DrawModelGPU(MODEL *m, MAT *worldmat, VEC *worldpos, short flag)
{
    ...
    D3Ddevice->SetRenderState(D3DRS_ALPHATESTENABLE, dwALPHATESTENABLE);
    D3Ddevice->SetRenderState(D3DRS_ALPHAREF, dwALPHAREF);
    ...
    // Draw the effect
    Assert(m->m_pEffect != NULL);
    m->m_pEffect->DrawEffect();
