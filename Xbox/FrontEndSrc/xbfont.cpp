  ...
  //      FLOAT ty1 = pGlyph->top;
    //    FLOAT tx2 = pGlyph->right;
      //  FLOAT ty2 = pGlyph->bottom;
        ...
        *m_pVertices++ = InitFontVertex( D3DXVECTOR4(sx1,sy2,0.0f,1.0f), dwColor, tx1, ty2 );
        *m_pVertices++ = InitFontVertex( D3DXVECTOR4(sx1,sy1,0.0f,1.0f), dwColor, tx1, ty1 );
        *m_pVertices++ = InitFontVertex( D3DXVECTOR4(sx2,sy1,0.0f,1.0f), dwColor, tx2, ty1 );
        *m_pVertices++ = InitFontVertex( D3DXVECTOR4(sx2,sy2,0.0f,1.0f), dwColor, tx2, ty2 );
        m_dwNumQuads++;
