...
extern D3DScene* CreateScene(void);
...
LPCTSTR     g_szMainName        = TEXT ("TrackEdit");
LPCTSTR     g_szMainClass		= TEXT ("TrackEditClass");
LPCTSTR     g_szMainTitle		= TEXT ("Re-Volt Track Editor");
