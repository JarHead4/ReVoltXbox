...
void OnKeyStroke (HWND hWindow, int vKeyCode);
...
**-----------------------------------------------------------------------------
**  Name:		OnKeyStroke
**  Purpose:	Pass keystorke down to window for handling
**-----------------------------------------------------------------------------
*/
...
void OnKeyStroke (HWND hWindow, int vKeyCode)
{
	...
	lpd3dWindow->OnKeyStroke (vKeyCode);
} // End OnPause
